...
class CandidateProfiles(models.Model):
    ...
    person_city = models.CharField(max_length=1000, null=True, blank=True)
    person_state = models.CharField(max_length=1000, null=True, blank=True)
    person_country = models.CharField(max_length=1000, null=True, blank=True)
    person_industry = models.CharField(max_length=1000, null=True, blank=True)
    tags = models.TextField(null=True, blank=True)
    person_skills = ArrayField(models.CharField(max_length=1000), blank=True, null=True)
    ...
    current_position_2 = models.CharField(max_length=1000, null=True, blank=True)
    current_company_2 = models.CharField(max_length=1000, null=True, blank=True)
    previous_position_2 = models.CharField(max_length=1000, null=True, blank=True)
    previous_company_2 = models.CharField(max_length=1000, null=True, blank=True)
    previous_position_3 = models.CharField(max_length=1000, null=True, blank=True)
    previous_company_3 = models.CharField(max_length=1000, null=True, blank=True)
    company_city = models.CharField(max_length=1000, null=True, blank=True)
    company_state = models.CharField(max_length=1000, null=True, blank=True)
    company_country = models.CharField(max_length=1000, null=True, blank=True)

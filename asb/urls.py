...
urlpatterns = [
    ...
    path('get-needs/<int:pk>/', views.get_needs, name='get_needs'),
    path('delete-need/<int:pk>/<int:need_id>/', views.delete_need, name='delete_need'),
    path('search-profile-with-needs/', views.search_profile_with_needs, name='search_profile_with_needs'),
